...
class GoGenerator(IGenerator):
    def __init__(self, out_dir: Path, module_path: str) -> None:
    ...
    def generate(self, service: Any) -> None:
        ...
        dest = self.out_dir / "clnrpc_generated.go"
        dest.write_text(self.render())
...
def main() -> int:
    ...
    generator = GoGenerator(args.out.resolve(), module_path(repo_root))
